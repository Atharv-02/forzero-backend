...
const {
  ...
  bustravelfootprint,
  aptfootprint,
  gasconsumptionfootprint,
  longflightsfootprint,
  shortflightsfootprint,
  roadtravel,
  electricitykwh,
  dietval,
...
app.get("/getfootprintval/:mail", async (req, res) => {
  ...
  try {
    ...
    const electricitykwhval = await electricitykwh(
      dataobj.electricityconsumtion
    );
    const totalvalue =
      roadtravelval +
      electricitykwhval +
      railwaytravel(dataobj.roadtravel) +
      bustravelfootprint(dataobj.bustravel) +
      gasconsumptionfootprint(dataobj.gasconsumption) +
      longflightsfootprint(dataobj.longflights) +
      railwaytravel(dataobj.railwaytravel) +
      shortflightsfootprint(dataobj.shortflights) +
      aptfootprint(dataobj.aptsize) +
      dietval(dataobj.diet);
